...
export default function StrainerValvesPage() {
  ...
  return (
    <main className="flex max-w-7xl mx-auto px-6 py-12 gap-8">
      ...
      <section className="flex-1">
        ...
        <div className="mb-6">
          <Image
            src="/images/strainers-valve-1.png"
            alt="Ball Valve"
            width={400}
            height={400}
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold text-gray-900 mb-2">'Y' , 'T' & 'Basket' TYPE STRAINERS</h1>
                {/* Tabs */}
        ...
        {activeTab === "features" && (
          <ul className="list-disc pl-6 space-y-2 ">
            ...
            <li>Size: 1″ – 16″ (15NB – 400NB)</li>
            <li>Class: 150#-1500#</li>
            <li>
                Design Code : BS / DIN / IS
            </li>
            <li>End Flange : ASME B16.5 / DIN / BS / IS</li>
            <li>
              Mat of Con : CS / SS / ALLOY STEEL / DSS / NI-ALLOYS / BRONZE
            </li>
            <li>Screen / Mesh : SS / Nickel / Inconel / Monel / Bronze</li>
        ...
        {activeTab === "specs" && (
          <div className="overflow-x-auto">
            <ul className="list-disc pl-6 space-y-2 ">
              <li>
                <b>Design : </b> ASME B16.34 / API 600 / ASTM F 1200-88
              </li>
              <li>
                <b>Face to Face : </b>API 598 / BS 6755
              </li>
              <li>
                <b>End to End : </b>SW / BW / Flanged / RTJ ends
              </li>
              <li>
              ...
              <li>
                <b>Flange connection : </b> ANSI B16.5
              </li>
              <li>
                <b>Pressure -Temperature Rating : </b> ASTM B 16.34
              </li>
              <li>
                <b>Face to face :</b> ANSI B 16.10
              </li>
