...
export default function ThreeWayValvesPage() {
  ...
  return (
    <main className="flex max-w-7xl mx-auto px-6 py-12 gap-8">
      ...
      <section className="flex-1">
        ...
        <div className="mb-6">
          <Image
            src="/images/three-way-ball-valve-1.png"
            alt="Ball Valve"
            width={400}
            height={400}
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold text-gray-900 mb-2">3 WAY & 4 WAY BALL VALVES</h1>
        ...
        {activeTab === "features" && (
          <ul className="list-disc pl-6 space-y-2 ">
            ...
            <li>
              3 Pieces / 4 Pieces Design - CS / SS / ALLOY STEEL / DSS / NI-ALLOYS / BRONZE
            </li>
            <li>L Port, T Port, L-L Port Design</li>
            <li>
              Anti -Static Device
            </li>
            <li>Blow-out Proof Stem.</li>
            <li>Fire Safe Design</li>
            <li>Low Emission</li>
            <li>Low Emission</li>
            <li>
Actucation - Hand Lever / Gear Box / Actuator - Pneumetic, Hydraulic, Electrical</li>
            <li>Speciality-Metal To Metal Seat</li>
