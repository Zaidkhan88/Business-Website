  ...
  return (
    <main className="flex max-w-7xl mx-auto px-6 py-12 gap-8">
      ...
      <section className="flex-1">
        ...
        <div className="mb-6">
          <Image
            src="/images/globe-valve-1.png"
            alt="Gloddbe Valve"
            width={400}
            height={400}
            className="rounded shadow border border-white object-contain"
          />
        </div>

        {/* Title */}
        <h1 className="text-3xl font-bold text-gray-900 mb-2">GLOBE VALVES</h1>
        ...
        {activeTab === "features" && (
          <ul className="list-disc pl-6 space-y-2 ">
            ...
            <li>Size: 1/2″ – 20″ (15NB – 500NB)</li>
            <li>Class: 150#-2500#</li>
            <li>
              CS / SS / Alloys / Monel / Hastalloys Steel / Bronze MOC
            </li>
            <li>Parabolic , Regulating, Throttle and Guid Type Plug</li>
            <li>
              Staight "T" Type, "Y" Type, Angle Type.
            </li>
            <li>Speciality : Below Sealed, Cryogenic, High Temp and with pressure balancing arrangement.</li>
            <li>Metal to Metal and Metal to soft seat</li>
            <li>Manual Operated / Gear Box / Pneumatic / Electrical Actuator</li>
